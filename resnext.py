...
model_name = "/home/ubin108/resNext/resNext101_epoch_5.pth"
weights = torch.load(f'{model_name}', map_location=device)
# DataParallel 래핑을 고려해 가중치 로드
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./resNext/resNext101_epoch_{epoch+1+5}.pth')

...
model = Unet(
    backbone='tf_efficientnetv2_xl_in21ft1k',
    in_channels=3,
    num_classes=1,
).to(device=device)#
...
model_name = "/home/ubin108/efficientnet_xl/efficientnetV2_xl_epoch_82.pth"
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(
    optimizer, T_0=1, T_mult=3, eta_min=2e-6,
)
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./efficientnet_xl/efficientnetV2_xl_epoch_{epoch+1+82}.pth')

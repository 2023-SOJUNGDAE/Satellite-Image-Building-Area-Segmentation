...
model_name = "/home/ubin108/data/unet_efficientnetV2_l_final.pth" #가중치 경로(수정)
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./efficientnet_l/efficientnetV2_l_epoch_{epoch+1}.pth')

...
model_name = "/home/ubin108/efficientnet_l/efficientnetV2_l_epoch_104.pth"
weights = torch.load(f'{model_name}', map_location=device)
model.load_state_dict(weights)

criterion = dice_loss()
init_lr = 0.00002  # 초기 학습률 설정
optimizer = torch.optim.AdamW(model.parameters(), lr=init_lr, weight_decay=1e-6)
max_epochs = 29
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./efficientnet_l/efficientnetV2_l_epoch_{epoch+1+104}.pth')

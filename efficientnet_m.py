...
model_name = "/home/ubin108/efficientnet_m/efficientnetV2_m_epoch_101_V2_80256.pth"
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./efficientnet_m/efficientnetV2_m_epoch_{epoch+1+101}_V2.pth')

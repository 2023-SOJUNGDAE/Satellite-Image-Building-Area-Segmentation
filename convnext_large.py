...
train_transform = A.Compose(
    [
        ...
        A.RandomBrightnessContrast(p=0.35), # 0.3 init
        A.RandomShadow(shadow_roi=(0, 0, 1, 1), p=0.3), # 0.3 init

        A.GridDistortion(p=0.25), # 0.2 init
        A.OneOf([
...
model_name = "/home/ubin108/convNext/convnext_large_in22ft1k_epoch_25.pth"
...
for epoch in range(max_epochs):  # epoch
    ...
    torch.save(model.state_dict(), f'./convNext/convNext_large_epoch_{epoch+1+25}_V2.pth')
